...
ipm2.itambere<- jags(bugs.data, inits, parameters, "ipm2-itambere-crc.jags",
...
saveRDS(ipm2.itambere, "results_imp2_Titambere.rds")
# summary(ipm2.itambere)
# ipm2.itambere.df<-ipm2.itambere$summary
# write.table(ipm2.itambere.df,"results_ipm2.itambere.txt",sep="\t")
